<div class="w-full sm:w-1/2 lg:w-3/4 bg-gray-100 dark:bg-gray-800 main-content relative">
	<div class="absolute top-5 left-6" wire:loading>
        <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-gray-400 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
	...
	<div class="transition" wire:loading.class="opacity-0">
		<div class="overflow-auto content-area-offset-bottom" id="replies">
			<div class="flex justify-between align-first">
				<h4 class="text-gray-900 dark:text-gray-200 font-bold text-2xl py-4 px-6 sticky top-0 dark:bg-gray-800 break-all">{{ $topic->title }}</h4>
